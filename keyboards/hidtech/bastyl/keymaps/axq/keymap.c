...
//---------*******************----------------------------//-----------------------------******************----------//
             LALT(KC_TAB), LT(1, KC_BSPC), LT(2, KC_DEL),     LT(2, KC_ENT), LT(1, KC_SPC), LALT(KC_TAB),
                           LT(4,KC_SPC),   LCTL(KC_TAB),      KC_F2,         LT(4, KC_TAB)
  ),
...
//---------**---------------------------------------------//---------------------------------------------**----------//
    _______, _______, _______, _______, KC_EQL,  _______,	  KC_ASTR, KC_4,    KC_5,    KC_6,    KC_PPLS, KC_EQL,
//---------**---------------------------------------------//---------------------------------------------**----------//
...
// Function Layer
  [4] = LAYOUT(
    KC_ESC,   _______,  RGB_RMOD, RGB_TOG,  RGB_MOD,  _______,       _______,  KC_MUTE,  KC_VOLD,  KC_VOLU,  _______,  RESET,
//----------**3x5***********************************************//****************************************************-------//
    _______,  _______,  _______,  C(KC_Z),  C(KC_Y),  _______,  	 KC_PSCR,  KC_F7,    KC_F8,    KC_F9,    KC_F12,   _______,
//----------**--------------------------------------------------//--------------------------------------------------**-------//
    _______,  KC_APP,   C(KC_X),  C(KC_C),  C(KC_V),  _______,       _______,  KC_F4,    KC_F5,    KC_F6,    KC_F11,   _______,
//----------**--------------------------------------------------//--------------------------------------------------**-------//
    RGB_HUI,  RGB_HUD,  RGB_SAI,  RGB_SAD,  RGB_VAI,  RGB_VAD,       _______,  KC_F1,    KC_F2,    KC_F3,    KC_F10,   _______,
//----------*****************-----------------------------------//----------------------------************************-------//
                                  _______,  _______,  _______,       _______,  _______,  _______,
                                            _______,  _______,       _______,  _______
  ),
